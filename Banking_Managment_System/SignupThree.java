...
JButton submit , cancel;
  ...
  SignupThree(String formno){
    ...
    JLabel l1 = new JLabel("Page 3: Account Details");
         ...
         add(r4);
          ...
          JLabel carddetails = new JLabel("Yours 16 Digit Card Number");
          ...
          JLabel pin_details = new JLabel("Yours 4 Digit Password");
          ...
          JLabel servises = new JLabel("Services Required:");
          servises.setFont(new Font("Raleway",Font.BOLD,22));
          servises.setBounds(100,450, 400, 30);
          add(servises);
  ...
  public void actionPerformed(ActionEvent es) {
     ...
     if(es.getSource() == submit){
             ...
             // contion to data base and should handle exeption
             try {
                if (accountType.equals("") ){
                  JOptionPane.showMessageDialog(null,"Account Type is Required");
                   ...
                   String querry3 = "insert into SignupThree values('"+formno+"','"+accountType+"','"+cardnumber+"','"+pinNumber+"','"+facility+"')"; 
